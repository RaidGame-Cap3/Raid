...
void FWaitReceiveDamageDelegate_DelegateWrapper(const FMulticastScriptDelegate& WaitReceiveDamageDelegate, URaidAbilitySystemComponent* SourceASC, float UnmitigatedDamage, float MitigatedDamage)
{
	...
	struct Z_CompiledInDeferFile_FID_RaidGame_Source_RaidGame_Character_Abilities_AbilityTasks_AT_WaitReceiveDamage_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RaidGame_Source_RaidGame_Character_Abilities_AbilityTasks_AT_WaitReceiveDamage_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RaidGame_Source_RaidGame_Character_Abilities_AbilityTasks_AT_WaitReceiveDamage_h_4188103123(TEXT("/Script/RaidGame"),
		Z_CompiledInDeferFile_FID_RaidGame_Source_RaidGame_Character_Abilities_AbilityTasks_AT_WaitReceiveDamage_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_RaidGame_Source_RaidGame_Character_Abilities_AbilityTasks_AT_WaitReceiveDamage_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
